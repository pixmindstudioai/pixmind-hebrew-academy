...
const PaymentsPage = () => {
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">סך הכל עסקאות</CardTitle>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Module Selector */}
            <div>
              <Label htmlFor="module-select">קורס</Label>
      ...
      <Card>
        <CardHeader>
          <CardTitle>עסקאות והרשמות</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          {isLoadingEnrollments ? (
            <div className="text-center py-8">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary mx-auto mb-4"></div>
              <p className="text-muted-foreground">טוען עסקאות...</p>
            </div>
          ) : enrollments.length === 0 ? (
            <div className="text-center py-8">
              <CreditCard className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
              <p className="text-muted-foreground">לא נמצאו עסקאות בטווח התאריכים שנבחר</p>
            </div>
          ) : (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>תאריך הענקה</TableHead>
                    ...
                    <TableRow key={enrollment.id}>
                      ...
                      <TableCell>
                        {enrollment.expires_at ? (
                          ...
                          <Badge variant="outline">ללא תפוגה</Badge>
                        )}
                      </TableCell>
                      <TableCell>
